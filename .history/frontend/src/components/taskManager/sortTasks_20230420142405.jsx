          ...
          <ul className="sort--lists">
            {sortedTasks.map((task, index) => (
              <li key={index} className="sort--list">
                ...
                <p className="task--item"><strong>Status: </strong>Status: {task.status}</p>
                <p className="task--item"><strong>Date Added: </strong>Date Added: {task.dateAdded}</p>
                <p className="task--item"><strong>Due date: </strong>Due Date: {task.dueDate}</p>
                <p className="task--item"><strong>Category: </strong>Category: {task.category}</p>
              </li>
            ))}
          </ul>
        </div>
