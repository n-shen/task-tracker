...
const TaskManager = () => {
  ...
  return (
    <div>
      ...
      <Routes>
        {/* Use Nested routes to render the ViewByCategory and Category task */}
        <Route path="index" element={<ViewByCategory tasks={tasks} />} >
          <Route path=":category" element={<CategoryTask tasks={tasks} />} />
        </Route>
      </Routes>
      <div>
